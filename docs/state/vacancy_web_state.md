...
- `src/lib/queries/vacancy.ts` allowlists aging buckets, urgency levels, vacant date strings, and supported sort fields before constructing RPC params. Unsupported values are dropped.
