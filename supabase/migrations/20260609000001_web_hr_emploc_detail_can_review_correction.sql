-- Migration: 20260609000001_web_hr_emploc_detail_can_review_correction.sql
-- Ticket: OHM2026_1113 - Add can_review_correction to HR Emploc detail capabilities
--
-- Purpose:
--   Keep the HR Emploc detail presentation RPC compatible with the Web
--   correction review mutation by exposing row_capabilities.can_review_correction.
--
-- Security invariants:
...
COMMENT ON FUNCTION public.get_web_hr_emploc_detail(uuid) IS
  'OHM2026_1113 - Web presentation detail contract. Adds row_capabilities.can_review_correction for correction review UI hints while preserving existing safe detail fields and security behavior.';
