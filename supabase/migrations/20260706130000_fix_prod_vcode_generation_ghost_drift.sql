...
COMMENT ON FUNCTION public.generate_vcode_for_account(uuid) IS 'Generates globally unique VCODE with dual format support (account_code fallback). Reasserted 2026-07-06 after confirmed regression: migration 20260817000001_fix_applicant_slot_sync_on_insert bundled an unrelated CREATE OR REPLACE of this function using the pre-fallback strict body, silently reverting 20260701000004/20260706112405/20260831000000. Live PROD body matched the 20260817000001 strict body byte-for-byte at time of diagnosis (ohm#x7k29a1pz), confirming 20260831000000 never actually took effect on PROD despite showing applied in migration history (ghost-applied migration, same pattern as ohm#vc0088 and ohm#vcode-uat-fix-a9x3k2p1 on staging).';
