-- Migration: 20261219000002_add_attrition_reason_to_detail_rpc.sql
-- Description: Update fn_get_attrition_details to return separation_status.
...
COMMENT ON FUNCTION public.fn_get_attrition_details(uuid, date, date) IS
  'Fetches separated employee detail records for the selected account in the specified date range. Enforces scope access checks, returns separation status.';
